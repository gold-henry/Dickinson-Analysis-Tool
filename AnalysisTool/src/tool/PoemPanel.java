...
public class PoemPanel extends JPanel {
	...
	public PoemPanel() {
		...
		String[] collections = {"Franklin Variorum 1998", "Johnson Poems 1955", "Poems 1890"};
		...
		CSelector.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
		        ...
		        } else if (selection.equals(Main.dataHandler.P)) {
		        	s = 2;
		        	NewCollection = Main.dataHandler.P;
		        }
		        ...
		        System.out.println("old poem num: " + poemNum + " in collection: " + collection);
		        poemNum = Main.RPN.getRelNum(Main.RPN.nameToNum(collection), poemNum, s);
		        collection = NewCollection;
		        NewCollection = null;
		        System.out.println("new poem num: " + poemNum + " in collection: " + collection);
		        System.out.println();
